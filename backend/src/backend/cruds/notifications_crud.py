...
_NOTIFICATION_COPY = {  # Шаблоны заголовков и текстов по типам уведомлений
    ...
    SCHEDULE_UPDATED_NOTIFICATION_TYPE: {  # график работ
        "title": "Обновление графика работ",  # заголовок push
        "actor_executor": "Исполнитель {actor} обновил график работ по заказу «{order}».",  # текст если актор — исполнитель
        "actor_customer": "Заказчик {actor} обновил график работ по заказу «{order}».",  # текст если актор — заказчик
    },
